...
python noise_ja.py -c $corpus -l $plabels -p $pset -o $data_art -e 5 -s 781
python noise_ja.py -c $corpus -l $plabels -p $pset -o $data_art -e 6 -s 1092
python noise_ja.py -c $corpus -l $plabels -p $pset -o $data_art -e 7 -s 10688
python noise_ja.py -c $corpus -l $plabels -p $pset -o $data_art -e 8 -s 50245
python noise_ja.py -c $corpus -l $plabels -p $pset -o $data_art -e 9 -s 71187
